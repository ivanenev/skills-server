 ...
 */
async function ensureLazyMCPConnection() {
 ...
 */
async function scanLazyMCPHierarchy(path = "") {
    const tools = [];
    try {
 ...
 */
function createTraditionalTool(toolPath, toolDef) {
 ...
 */
function inferInputSchema(toolDef) {
